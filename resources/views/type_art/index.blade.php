...
<head>
    <meta charset="UTF-8">
    <title>Liste Types Articles</title>
                    ...
                    <div class="panel panel-success filterable" style="overflow:auto;">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary" href="{{route('type_art.create')}}" role="button">Ajout Type Article</a>
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                <tbody>
                                @foreach($typeArts as $typeArt)
                                    <tr>
                                        <td>{{$typeArt->idTypeArt}}</td>
                                        <td>{{$typeArt->libelleTypeArt}}</td>
                                        <td>

                                            <a href="{{route('type_art.edit',$typeArt->idTypeArt)}}" class="btn btn-success">
                                                <span class="livicon" data-name="pen" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></span>
                                            </a>

                                            <a href="{{route('type_art.delete',$typeArt->idTypeArt)}}" class="btn btn-danger" role="button">
