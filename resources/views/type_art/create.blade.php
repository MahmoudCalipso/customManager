...
<head>
    <meta charset="UTF-8">
    <title>Nouveau Type Article</title>
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="doc-portrait" data-c="#fff" data-hc="#fff" data-size="18" data-loop="true"></i> Ajouter Type Article
                            </h3>

                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <form method="post" class="form-horizontal" action="{{ route('type_art.store') }}">
                                    @csrf
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-3" for="libelleTypeArt">Type Article :</label>
                                            <div class="col-md-9">
                                                <input type="text" name="libelleTypeArt" class="form-control" id="libelleTypeArt" placeholder="Ajouter Type Article">
                                            </div>
                                        </div>
