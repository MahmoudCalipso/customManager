                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="Art_Ref"class="form-control" id="RefArt" placeholder="Reference article">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="desArt">Designation Article:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="Art_Designation" class="form-control" id="desArt" placeholder="Designation Article">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="cdBar">Code Barre:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="Art_CodeBarre" class="form-control" id="cdBar" placeholder="Code A Barre Article">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="qteArt">Qte Article:</label>
                                                            <div class="col-md-9">
                                                                <input type="number" name="Qte" class="form-control" id="qteArt" placeholder="Qte Articles">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="DateAchat" class="form-control" id="rangepicker4" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="Art_HT" class="form-control" id="prixAchHT" placeholder="Prix Achat HT">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="prixAchTTC">Prix Achat TTC:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="Art_TTC"class="form-control" id="prixAchTTC" placeholder="Prix Achat TTC">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="ArtRv_HT" class="form-control" id="prixVentHT" placeholder="Prix vente HT">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="ArtRv_TTC" class="form-control" id="ArtRv_TTC" placeholder="Prix vente TTC">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="Art_PrixUht">Prix Vente Unitaire ht:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="Art_PrixUht" class="form-control" id="Art_PrixUht" placeholder="Prix vente unitaire ht">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="Art_PrixUTtc">Prix Vente Unitaire ttc:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="Art_PrixUTtc" class="form-control" id="Art_PrixUTtc" placeholder="Prix vente unitaire ttc">
                                                            </div>
                                                        </div>
