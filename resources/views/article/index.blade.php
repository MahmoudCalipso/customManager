                    ...
                    <div class="panel panel-success filterable" style="overflow:auto;">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary" href="{{route('article.create')}}" role="button">Ajout Article</a>
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                @foreach($articles as $articles)
                                    <tr>
                                        <td>{{$articles->Art_Id}}</td>
                                        <td>{{$articles->Art_Designation}}</td>
                                        <td><img src="{{$articles->Art_Image}}" style="width: 30px;height: 30px;border-radius: 20px"></td>
                                        <td>{{$articles->Qte}}</td>
                                        <td>{{$articles->DateAchat}}</td>
                                        <td>{{$articles->ArtA_HT}}</td>
                                        <td>{{$articles->ArtA_TTC}}</td>
                                        <td>{{$articles->ArtV_HT}}</td>
                                        <td>{{$articles->ArtV_TTC}}</td>

                                        <td>

                                            <a href="{{route('article.edit',$articles->Art_Id)}}" class="btn btn-success">
                                                <span class="livicon" data-name="pen" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></span>
                                            </a>

                                            <a href="{{route('article.delete',$articles->Art_Id)}}" class="btn btn-danger" role="button">
