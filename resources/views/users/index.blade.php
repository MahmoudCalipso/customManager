                    ...
                    <div class="panel panel-success filterable" style="overflow:auto;">
                        ...
                        <div class="panel-heading ">
                            ...
                            <h3 class="panel-title">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary" href="" role="button">Ajout Utilisateur</a>
                                </div>
                                <br><br>
                            </h3>
                            ...
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                      ...
                                      <td>
                                          <a href="{{route('users.edit',$user->User_Id)}}" class="btn btn-success">
                                              <span class="livicon" data-name="pen" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></span>
                                          </a>

                                          <a href="{{route('users.delete',$user->User_Id)}}" class="btn btn-danger" role="button">
