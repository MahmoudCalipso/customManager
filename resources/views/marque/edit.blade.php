                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form method="post" action="{{ route('marque.update', $marque->Marque_Id) }}">
                                    @csrf
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-3" for="marque">Marque Article :</label>
                                            <div class="col-md-9">
                                                <input type="text" name="Marque_Intitule" class="form-control" id="marque" value="{{$marque->Marque_Intitule}}">
                                            </div>
                                        </div>
                                        <br><br>
