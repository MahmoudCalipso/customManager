                    ...
                    <div class="panel panel-success filterable" style="overflow:auto;">
                        ...
                        <div class="panel-heading ">
                            ...
                            <h3 class="panel-title">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary" href="{{route('client.create')}}" role="button">Ajout Client</a>
                                ...
                                @foreach($clients as $cl)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a  href="{{route('client.edit',$cl->Code)}}" class="btn btn-success">
                                                <span class="livicon" data-name="pen" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></span>
                                            </a>

                                            <a href="{{route('client.delete',$cl->Code)}}" class="btn btn-danger" role="button">
