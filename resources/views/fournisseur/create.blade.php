...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            @endif
                <form method="post" action="{{ route('fournisseur.store') }}" class="form-horizontal">
                    @csrf
            <div class="row">
                <div class="col-lg-12">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="first_Name">Type Fournisseur:</label>
                                                            <div class="col-md-9">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" name="prenom" id="input_Password" placeholder="">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="input_Password" placeholder="" name="email">
                                                            </div>
                                                        </div>
