                    ...
                    <div class="panel panel-success filterable" style="overflow:auto;">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary" href="{{route('fournisseur.create')}}" role="button">Ajout Fournisseur</a>
                                ...
                                @foreach($fournisseurs as $fr)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a  href="{{route('fournisseur.edit',$fr->Four_Id)}}" class="btn btn-success">
                                                <span class="livicon" data-name="pen" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></span>
                                            </a>

                                            <a href="{{route('fournisseur.delete',$fr->Four_Id)}}" class="btn btn-danger" role="button">
