...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            <form method="post" action="{{route('fournisseur.update',$for->Four_Id)}}" class="form-horizontal">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="select-gear" class="form-control" name="civilite">
                                                                    <option value=""></option>
                                                                    <option value="monsieur"  @if($for->civilite==='monsieur') selected='selected' @endif>Monsieur</option>
                                                                    <option value="madame" @if($for->civilite==='madame') selected='selected' @endif>Madame</option>
                                                                    <option value="mademoiselle" @if($for->civilite==='mademoiselle') selected='selected' @endif>Mademoiselle</option>
                                                                    <option value="monsieuroumadame"@if($for->civilite==='monsieuroumadame') selected='selected' @endif>Monsieur ou Madame</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="select-gear" class="form-control" name="typefr">
                                                                    <option value=""></option>
                                                                    <option value="fidele" @if($for->typefr==='fidele') selected='selected' @endif>Fidéle</option>
                                                                    <option value="passager" @if($for->typefr==='passager') selected='selected' @endif>Passager</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control"  value="{{$for->nom}}" name="nom">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="prenom" >Prénom:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="prenom" value="{{$for->prenom}}" name="prenom">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control"  value="{{$for->tel1}}" name="tel1">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="input_Email" >Téléphone 2:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="input_Email"  value="{{$for->tel2}}" name="tel2">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="email" >Email:</label>
                                                            <div class="col-md-9">
                                                                <input type="email" class="form-control" id="email" value="{{$for->email}}" name="email">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="fax" value="{{$for->fax}}" name="fax">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="GSM" >GSM:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="GSM" value="{{$for->gsm}}" name="gsm">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="form-control resize_vertical" rows="3"  name="adresse">{{$for->adresse}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="codepostal" value="{{$for->codePostal}}" name="codepostal">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="ville" >Ville:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="ville" value="{{$for->ville}}" name="ville">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3" for="pays" >Pays:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" value="{{$for->pays}}" name="pays">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control"  value="{{$for->matfiscal}}" name="matricule">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label col-md-3" for="raison_soc" >Raison Social:</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control"  value="{{$for->Raison_Social}}" name="social">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="rangepicker4" value="{{$for->datecrea}}" name="date"/>
                                                                </div>
